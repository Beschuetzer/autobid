...
export var getSuitFromCardAsNumber = function (cardAsNumber) {
	if (cardAsNumber >= 0 && cardAsNumber <= 12) return "club";
	else if (cardAsNumber >= 13 && cardAsNumber <= 25) return "diamond";
	else if (cardAsNumber >= 26 && cardAsNumber <= 38) return "heart";
