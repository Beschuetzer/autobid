...
#NOTE: IS IT SAFE TO SAY WE ONLY WANT TO ADJUST BOUNDS WHEN ONLY 2 BID OPPOPUNITIES IF THE FIRST BID IS PASS?
...
class getEstimatedPoints_2_Bid_Opportunities(unittest.TestCase):
    ...
    #NOTE: WOULD WE WANT TO ADJUST MAX FOR RIGHT HERE BECAUSE THEIR FIRST SUIT SAID WAS NOT NT AND DOUBLE MAX IS SAME AS NT MAX? 
    ...
    #NOTE: WHAT WOULD WE EXPECT RIGHT TO HAVE HERE?
    ...
    #NOTE: DO WE WANT TO HAVE THE ADJUSTED AMOUNT BE DEPENDENT ON THE LEVEL OF THE BID MADE IN PASS-THEN-BID-SOMETHING SCENARIOS?
    ...
    #NOTE: WHAT CAN WE SAY ABOUT RIGHT'S DOUBLE HERE REGARDING POINT COUNT?  CAN WE CAN GENERALIZE PASS-FIRST-DOUBLE-SECOND OR IS IT VERY CASE SPECIFIC?
    ...
    #note: if feels like we should adjust the max possible for left, right or left and right here maybe to 10?
    ...
    def test_update_Partner_Has_Opened_Pass_First_Jumpshift_Suit_Second(self):
        ...
        self.expected = {
            "left": {
                "min": getEstimatedPoints.values['passFirstBidSecond']['partnerHasOpened']['isJumpshift']['min'],
                "max": getEstimatedPoints.values['passFirstBidSecond']['partnerHasOpened']['isJumpshift']['max'],
            },
            "top": {
                "min": self.estimatedScoringBounds['top']['min'],
                "max": self.estimatedScoringBounds['top']['max'],
    ...
    def test_update_Partner_Has_Not_Opened_Pass_First_Jumpshift_Suit_Second(self):
        ...
        self.expected = {
            "left": {
                "min": getEstimatedPoints.values['passFirstBidSecond']['partnerHasNotOpened']['isJumpshift']['min'],
                "max": getEstimatedPoints.values['passFirstBidSecond']['partnerHasNotOpened']['isJumpshift']['max'],
            },
            "top": {
                "min": self.estimatedScoringBounds['top']['min'],
                "max": self.estimatedScoringBounds['top']['max'],
