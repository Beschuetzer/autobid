...
class getEstimatedPointsModule(unittest.TestCase):
    ...
    def test_2_WeakTwo_5(self):
        ...
        self.assertDictEqual(actual, expected)
    def test_2_Weak_Three_Bid_1(self):
        biddingObjRelative = {
            "left": [],
            "top": ['Three Diamond'],
            "right": ['pass'],
        ...
        self.assertDictEqual(actual, expected)
    def test_2_Weak_Three_Bid_2(self):
        biddingObjRelative = {
            "left": [],
            "top": ['pass'],
            "right": ['Three Diamond'],
        ...
        self.assertDictEqual(actual, expected)
    def test_2_Weak_Three_Bid_3(self):
        biddingObjRelative = {
            "left": ['pass'],
            "top": ['pass'],
            "right": ['Three Diamond'],
        ...
        self.assertDictEqual(actual, expected)
    def test_2_Weak_Three_Bid_4(self):
        biddingObjRelative = {
            "left": ['One Diamond'],
            "top": ['Three Heart'],
            "right": ['pass'],
